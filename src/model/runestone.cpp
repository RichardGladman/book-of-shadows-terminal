...
Runestone::Runestone(const std::string &name, const std::string &meaning) :
        ...
        m_tarot_card {std::shared_ptr<TarotCard> {}}, m_trees {std::vector<Tree> {}}, m_zodiacs {std::vector<Zodiac> {}} {}

Runestone::Runestone(const Runestone &source) : m_name {source.m_name}, m_meaning {source.m_meaning}, m_colours {source.m_colours},
        m_gods {source.m_gods}, m_herbs {source.m_herbs}, m_planets {source.m_planets}, m_polarity {source.m_polarity},
        m_tarot_card {source.m_tarot_card}, m_trees {source.m_trees}, m_zodiacs {source.m_zodiacs} {}
